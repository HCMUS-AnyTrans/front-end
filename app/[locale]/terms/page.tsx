...
export default async function TermsPage({
  ...
  const jsonLd = {
    ...
    '@type': 'WebPage',
    name: 'Terms of Service - Anytrans',
    description:
      'Read our terms of service and understand the rules and guidelines for using Anytrans.',
    url: `${process.env.NEXT_PUBLIC_BASE_URL || 'https://anytrans.me'}/${locale}/terms`,
    inLanguage: locale,
    publisher: {
      '@type': 'Organization',
      name: 'Anytrans',
