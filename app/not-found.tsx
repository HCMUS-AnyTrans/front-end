...
// Simple i18n for root not-found page (standalone component)
const translations = {
  en: {
    title: '404',
    heading: 'Oops! Page Not Found',
    description:
      "The page you're looking for seems to have wandered off into the translation cosmos. Don't worry though, we'll help you find your way back!",
  ...
  vi: {
    title: '404',
    heading: 'Rất tiếc! Không tìm thấy trang',
    description:
      'Trang bạn đang tìm kiếm dường như đã đi lạc vào vũ trụ dịch thuật. Đừng lo lắng, chúng tôi sẽ giúp bạn tìm đường về!',
    ...
    supportDesc: 'Đội hỗ trợ của chúng tôi luôn sẵn sàng hỗ trợ bạn',
...
export default function RootNotFound() {
  ...
  useEffect(() => {
    ...
    if (cookieLocale && (cookieLocale === 'en' || cookieLocale === 'vi')) {
      ...
      setLocale(browserLang.startsWith('vi') ? 'vi' : 'en');
    }
  }, []);
