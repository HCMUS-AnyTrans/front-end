  ...
  return (
    <div className="bg-gradient-to-br from-blue-600 to-indigo-600 rounded-xl p-6 text-white">
      ...
      <div className="flex gap-3 mt-6">
        <button
          onClick={onUpgrade}
          className="flex-1 bg-white hover:bg-blue-50 text-blue-700 px-4 py-2.5 rounded-lg font-semibold text-sm transition-all flex items-center justify-center gap-2"
        >
        ...
        <button
          ...
          className="px-4 py-2.5 bg-white/10 hover:bg-white/20 border border-white/30 text-white rounded-lg font-semibold text-sm transition-all"
        >
          Cancel Plan
        </button>
      </div>
