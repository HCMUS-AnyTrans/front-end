...
export default function BaseActionCard({
  ...
  return (
    <button
      onClick={onClick}
      className={`bg-white rounded-xl p-6 border-2 border-gray-200 hover:border-${color}-500 hover:shadow-lg transition-all group text-left cursor-pointer ${className}`}
    >
      <div
