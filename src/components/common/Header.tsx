...
function NavLink({ href, children, className = "", onClick }: NavLinkProps) {
  const baseClasses = "px-4 py-2 rounded-md font-semibold text-base transition-colors cursor-pointer";
  const homeClasses = href === "/" ? "text-slate-900 hover:bg-gray-50" : "text-[#717680] hover:bg-gray-50";
  ...
  return (
    <div className="flex flex-col space-y-4 pt-6">
      ...
      <div className="space-y-2">
        ...
        >
          Features
          <ChevronDown className={`h-4 w-4 transform transition-transform ${featuresOpen ? 'rotate-180' : ''}`} />
        </button>
        
        {featuresOpen && (
          <div className="pl-4 space-y-2">
            <NavLink href="/features/document-translation" className="block" onClick={onClose}>
              Document Translation
            </NavLink>
            <NavLink href="/features/subtitle-translation" className="block" onClick={onClose}>
