...
export default async function DashboardPage({ params }: Props) {
  ...
  return (
    <div className="flex w-full flex-col gap-4 overflow-x-hidden py-4 sm:gap-6 md:py-6 lg:py-8">
      {/* Header */}
      <AppCard className="overflow-hidden rounded-3xl border-border/70 bg-[#eef5ff]">
        <AppCardContent
          padding="none"
        ...
        >
          <Image
            ...
            height={220}
            priority
            className="pointer-events-none absolute left-1/2 top-0 h-auto w-[360px] max-w-none -translate-x-1/2 opacity-80 sm:w-[440px] lg:w-[560px]"
          />
